			...
			if(blocklyScriptCompleted && !moving) {
				...
				if(starCollected === 15 && runOnce) {
					...
					if(totalBlocksUsed === 24){
						...
						levelBadge = 1;
						outputArea.value +=  '\n Συγχαρητήρια. Χρησιμοποίησες τον ελάχιστο αριθμό μπλοκ για να κερδίσεις το Επίπεδο 8. Θα ανταμειφτείς με +100 πόντους, οι οποίοι θα προστεθούν στο τρέχον σκορ σου! Το συνολικό σου σκορ είναι: '+((blocklyPoints + totalScore + levelScore) - Number(losePoints())) + "";
					...
					runOnce = false;
					outputArea.value +=  '\n';
					outputArea.value +=  'Συμβουλή:  Έλεγξε την εικόνα στις οδηγίες η οποία εξηγεί πώς λειτουργούν οι εμφωλευμένες if εντολές. Μέσα στην εμφωλευμένη if εντολή θα πρέπει να χρησιμοποιήσεις μόνο το jump and collect option balloon μπλοκ. Μετά από αυτό, χρησιμοποίησε το collect option star μπλοκ έξω απο το εμφωλευμένο if μπλοκ και μέσα στο πρώτο  If μπλοκ';
					outputArea.value +=  '\n';
					outputArea.value +=  '\n';
					...
					for( var i=0; i < blocks.length; i++) {
						if( i === 0){
							...
							if(blocks[i].type !== "move_up") {
								outputArea.value +=  '\nBlock '+(i + 1)+': Χρησιμοποίησε το "jump" μπλοκ μέσα στο repeat μπλοκ.\n';
								break;
							}
						}else if(i === 3) {
							...
							if(blocks[i].type !== "controls_if") {
								outputArea.value +=  '\nBlock '+(i + 1)+': Χρησιμοποίησε το "if" μπλοκ \n';
								break;
							}
						}else if(i === 5) {
							...
							if(blocks[i].type !== "controls_if") {
								outputArea.value +=  '\nBlock '+(i + 1)+': Χρησιμοποίησε το "if" block. Αυτό το "if" μπλοκ θα πρέπει να τοποθετηθεί μέσα (εμφωλευμένο) στο προηγούμενο "if" μπλοκ στο οποίο έκανες τον έλεγχο για το χρώμα του αστεριού.\n';
								break;
							}
						}else if(i === 7) {
							if(blocks[i].type !== "star_hasballon") {
								outputArea.value +=  '\nBlock '+(i + 1)+': Χρησιμοποίησε το "star has balloon on top" μπλοκ δίπλα στο εμφωλευμένο if μπλοκ.\n';
								break;
							}
						}else if(i === 8) {
							if(blocks[i].type !== "collect_balloon") {
								outputArea.value +=  '\nBlock '+(i + 1)+': Χρησιμοποίησε το "jump and collect options balloon" μπλοκ μέσα στο εμφωλευμένο "if" μπλοκ.\n';
								break;
							}
						}
						else if(i === 9) {
							if(blocks[i].type !== "collect_star") {
								outputArea.value +=  '\nBlock '+(i + 1)+': Χρησιμοποίησε το "collect option star" μπλοκ έξω από το εμφωλευμένο "if" μπλοκ.\n';
								break;
							}
						}else if(i === 10) {
							if(blocks[i].type !== "star_color") {
								outputArea.value +=  '\nBlock '+(i + 1)+': Επέκτεινε το πρώτο απλό "if" μπλοκ και πρόσθεσε ένα "if-else" μπλοκ. Χρησιμοποίησε το "star has option color" μπλοκ δίπλα στην "else if".\n';
								break;
							}
						}else if(i === 11) {
							if(blocks[i].type !== "controls_if") {
