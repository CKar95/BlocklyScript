...
var blocklyDiv = document.getElementById('blocklyDiv');
    ...
    function runCode() {
      if (!myInterpreter) {
		...
		totalBlocksUsed = (moveLeft + startBlock + moveRight + jumpBlock) + (useLaserBeam + shootBeamDir + repeatNTimes) + repeatWhile + repeatUntil + (ifBlocks + starHasColor+ collectColor) + (starHasBalloon + collectBalloon);
		...
		blocksUsedText += "\nΦορές που επανέλαβες το Επίπεδο 8: " + (level8timesreseted + gameTimesReseted) +"\n";
