...
var blocklyDiv = document.getElementById('blocklyDiv');
    ...
    function runCode() {
      if (!myInterpreter) {
		...
		totalBlocksUsed = (moveLeft + startBlock + moveRight + jumpBlock) + (useLaserBeam + shootBeamDir + repeatNTimes) + repeatWhile + repeatUntil + (ifBlocks + starHasColor+ collectColor) + (starHasBalloon + collectBalloon) + (method + callMethod);
		...
		blocksUsedText += "If μπλοκ που χρησιμοποίηθηκαν: " + ifBlocks + "\n";
		blocksUsedText += "star has: 'options' color μπλοκ που χρησιμοποίηθηκαν: " + starHasColor + "\n";
		blocksUsedText += "collect 'options' star μπλοκ που χρησιμοποίηθηκαν: " + collectColor + "\n";
		blocksUsedText += "star has balloon on top μπλοκ που χρησιμοποίηθηκαν: " + starHasBalloon + "\n";
		blocksUsedText += "jump and collect 'options' balloon μπλοκ που χρησιμοποίηθηκαν: " + collectBalloon + "\n";
		blocksUsedText += "method μπλοκ που χρησιμοποίηθηκαν: " + method + "\n";
		blocksUsedText += "call method μπλοκ που χρησιμοποίηθηκαν: " + callMethod + "\n";
		blocksUsedText += "Συνολικά μπλοκ που χρησιμοποίηθηκαν: " + totalBlocksUsed + "\n";
		blocksUsedText += "\nΦορές που επανέλαβες το Επίπεδο 9: " + (level9timesreseted + gameTimesReseted) +"\n";
