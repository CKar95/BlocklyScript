			...
			if(blocklyScriptCompleted && !moving) {
				...
				if(starCollected === 15 && runOnce) {
					...
					if(totalBlocksUsed === 18){
						...
						levelBadge = 1;
						outputArea.value +=  '\n Συγχαρητήρια. Χρησιμοποίησες τον ελάχιστο αριθμό μπλοκ για να κερδίσεις το Επίπεδο 4. Θα ανταμειφτείς με +100 πόντους, οι οποίοι θα προστεθούν στο τρέχον σκορ σου! Το συνολικό σου σκορ είναι: '+((blocklyPoints + totalScore + levelScore) - Number(losePoints())) + "";
						...
						outputArea.value +=  '\n';
						outputArea.value +=  '\n Καλή προσπάθεια. Ολοκλήρωσες το Επίπεδο 4. Ωστόσο χρησιμοποίησες περισσότερα μπλοκ για να κερδίσεις το Επίπεδο 4 από ότι χρειαζόταν και για αυτόν το λόγο θα ανταμειφτείς με +40 πόντους, οι οποίοι θα προστεθούν στο τρέχον σκορ σου! Το συνολικό σου σκορ είναι: ' +((blocklyPoints + totalScore + levelScore)  - Number(losePoints()))+ "";
						
					}else if(totalBlocksUsed < 18){
						blocklyPoints = 150;
						document.getElementById("levelbadge").src="../assets/first.png";
						levelBadge = 1;
						outputArea.value +=  '\n Συγχαρητήρια. Ολοκλήρωσες το Επίπεδο 4 χρησιμοποιώντας λιγότερα μπλοκ από ότι χρειαζόταν. Θα ανταμειφτείς με +150 πόντους, οι οποίοι θα προστεθούν στο τρέχον σκορ! Το συνολικό σου σκορ είναι: ' +((blocklyPoints + totalScore + levelScore)  - Number(losePoints()))+ "";
					...
					runOnce = false;
					outputArea.value +=  '\n';
					outputArea.value +=  'Συμβουλή: Το "Repeat while wall is" μπλοκ θα επαναλάβει όλα τα μπλοκ εντολών που έβαλες μέσα του εάν η συνθήκη (broken or not broken) είναι αληθής.';
					outputArea.value +=  '\n';
					...
					for( var i=0; i < blocks.length; i++) {
						if( i === 0){
							...
							if(blocks[i].type !== "repeat_while") {
								outputArea.value +=  '\nBlock '+(i + 1)+': Χρησιμοποίησε το "repeat while wall is" μπλοκ με την σωστή συνθήκη. \n';
								break;
							}
						}else if(i === 2) {
							...
							if(blocks[i].type !== "laser_beamdirection") {
								outputArea.value +=  '\nBlock '+(i + 1)+': Έδωσες την κατεύθυνση για την ακτίνα φωτός;\n';
								break;
							}
						}else if(i === 4) {
							...
							if(blocks[i].type !== "move_up") {
								outputArea.value +=  '\nBlock '+(i + 1)+': Χρησιμοποίησε το jump μπλοκ εδώ. Αυτό το μπλοκ θα πρέπει να βρίσκεται έξω από το reapeat N times μπλοκ\n';
								break;
							}
						}else if(i === 7) {
							if(blocks[i].type !== "move_right") {
							...
							if(blocks[i].type !== "laser_beam") {
								outputArea.value +=  '\nBlock '+(i + 1)+': Χρησιμοποίησε το laser beam μπλοκ εδώ.\n';
								break;
							}
						}
						else if(i === 9) {
							...
							if(blocks[i].type !== "controls_repeat") {
								outputArea.value +=  '\nBlock '+(i + 1)+': Χρησιμοποίησε το repeat N times μπλοκ εδώ.\n';
								break;
							}
						}else if(i === 11) {
