...
var blocklyDiv = document.getElementById('blocklyDiv');
    ...
    function runCode() {
      if (!myInterpreter) {
		...
		totalBlocksUsed = (moveLeft + startBlock + moveRight + jumpBlock) + (useLaserBeam + shootBeamDir + repeatNTimes) + repeatWhile + repeatUntil + (ifBlocks + starHasColor+ collectColor);
		...
		blocksUsedText += "Repeat until wall is μπλοκ που χρησιμοποίηθηκαν: " + repeatUntil + "\n";
		...
		blocksUsedText += "\nΦορές που επανέλαβες το Επίπεδο 7: " + (level7timesreseted + gameTimesReseted) +"\n";
