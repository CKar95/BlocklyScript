...
var blocklyDiv = document.getElementById('blocklyDiv');
    ...
    function runCode() {
      if (!myInterpreter) {
		...
		totalBlocksUsed = (moveLeft + startBlock + moveRight + jumpBlock) + (useLaserBeam + shootBeamDir + repeatNTimes);
		...
		blocksUsedText += "\nΦορές που επανέλαβες το Επίπεδο 3: " + (level3timesreseted + gameTimesReseted) +"\n";
