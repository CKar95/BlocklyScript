...
var blocklyDiv = document.getElementById('blocklyDiv');
    ...
    function runCode() {
      if (!myInterpreter) {
		...
		totalBlocksUsed = (moveLeft + startBlock + moveRight + jumpBlock) + (useLaserBeam + shootBeamDir + repeatNTimes) + repeatWhile + repeatUntil;
		...
		blocksUsedText += "\nΦορές που επανέλαβες το Επίπεδο 5: " + (level5timesreseted + gameTimesReseted) +"\n";
