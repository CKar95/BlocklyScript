...
var blocklyDiv = document.getElementById('blocklyDiv');
    ...
    function runCode() {
      if (!myInterpreter) {
		...
		blocksUsedText += "set 'variable' to μπλοκ που χρησιμοποίηθηκαν: " + setPassword + "\n";
		blocksUsedText += "open door with password: 'variable' μπλοκ που χρησιμοποίηθηκαν: " + openDoorWithPass + "\n";
		blocksUsedText += "Συνολικά μπλοκ που χρησιμοποίηθηκαν: " + totalBlocksUsed + "\n";
		blocksUsedText += "\nΦορές που επανέλαβες το Επίπεδο 11: " + (level11timesreseted + gameTimesReseted) +"\n";
