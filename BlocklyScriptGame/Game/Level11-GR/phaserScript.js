			...
			if(blocklyScriptCompleted && !moving) {
				...
				if(starCollected === 10 && runOnce) {
					...
					if(totalBlocksUsed === 15){
						...
						levelBadge = 1;
						outputArea.value +=  '\n Συγχαρητήρια. Χρησιμοποίησες τον ελάχιστο αριθμό μπλοκ για να κερδίσεις το Επίπεδο 11. Θα ανταμειφτείς με +100 πόντους, οι οποίοι θα προστεθούν στο τρέχον σκορ σου! Το συνολικό σου σκορ είναι: '+((blocklyPoints + totalScore + levelScore) - Number(losePoints())) + "";
						...
						outputArea.value +=  '\n';
						outputArea.value +=  '\n Καλή προσπάθεια. Ολοκλήρωσες το Επίπεδο 11. Ωστόσο χρησιμοποίησες περισσότερα μπλοκ για να κερδίσεις το Επίπεδο 11 από ότι χρειαζόταν και για αυτόν το λόγο θα ανταμειφτείς με +40 πόντους, οι οποίοι θα προστεθούν στο τρέχον σκορ σου! Το συνολικό σου σκορ είναι: ' +((blocklyPoints + totalScore + levelScore)  - Number(losePoints()))+ "";
						
					}else if(totalBlocksUsed < 15){
						blocklyPoints = 100;
						document.getElementById("levelbadge").src="../assets/first.png";
						levelBadge = 1;
						outputArea.value +=  '\n Συγχαρητήρια. Ολοκλήρωσες το Επίπεδο 11. Θα ανταμειφτείς με +100 πόντους, οι οποίοι θα προστεθούν στο τρέχον σκορ σου! Το συνολικό σου σκορ είναι: ' +((blocklyPoints + totalScore + levelScore)  - Number(losePoints()))+ "";
					...
					runOnce = false;
					outputArea.value +=  '\n';
					outputArea.value +=  'Συμβουλή:  Προκειμένου να ανοίξεις την πόρτα χρειάζεσαι το συνθηματικό. Πάτησε και κράτησε το αριστερό κλικ πάνω από τον/την εξερευνητή/τρια για να μάθεις το συνθηματικό. Αποθήκευσε το συνθηματικό μέσα στην μεταλβητή και μετά άνοιξε την πόρτα χρησιμοποιώντας το όνομα της συγκεκριμένης μεταβλητής.';
					outputArea.value +=  '\n';
					outputArea.value +=  '\n';
					...
					for( var i=0; i < blocks.length; i++) {
						if( i === 0){
							...
							if(blocks[i].type !== "variables_set") {
								outputArea.value +=  '\nBlock '+(i + 1)+': Χρησιμοποίησε το "set variable to" μπλοκ. Μέσα στην γκρι περιοχή πληκτρολόγησε το σωστό συνθηματικό. \n';
								break;
							}
						}else if(i === 2) {
							if(blocks[i].type !== "open_door") {
								outputArea.value +=  '\nBlock '+(i + 1)+': Χρησιμοποίησε το "open door with password: variable" μπλοκ.\n';
								break;
							}
						}else if(i === 3) {
